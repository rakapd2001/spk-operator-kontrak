...
// ======================================================
// GET /api/hasil-penilaian/:id
// Detail nilai penilaian berdasarkan IdHasilPSI
// ======================================================
  ...
  try {
    ...
    if (!IdHasilPSI || Number.isNaN(IdHasilPSI)) {
      return NextResponse.json(
        {
          success: false,
          message: "ID hasil penilaian tidak valid.",
        },
        { status: 400 },
      );
    }
    ...
    if (!hasil) {
      return NextResponse.json(
        {
          success: false,
          message: "Hasil penilaian tidak ditemukan.",
        },
        { status: 404 },
      );
    }
    ...
    return NextResponse.json({
      success: true,
      message: "Detail hasil penilaian berhasil diambil.",
    ...
    console.error("GET DETAIL HASIL PENILAIAN ERROR:", error);

    return NextResponse.json(
      {
        success: false,
        message: "Gagal mengambil detail hasil penilaian.",
        data: null,
        error:
